...
export const getStaticProps: GetStaticProps = async () => {
    ...
    return { props: { page_info, kirurgija, services, services_subprices } };
};

const Kirurgija = ({ page_info, kirurgija, services, services_subprices }: InferGetStaticPropsType<typeof getStaticProps>) => {
