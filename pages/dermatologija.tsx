...
export const getStaticProps: GetStaticProps = async () => {
    ...
    return { props: { page_info, dermatologija, services, services_prices } };
};

const Dermatologija = ({ page_info, dermatologija, services, services_prices }: InferGetStaticPropsType<typeof getStaticProps>) => {
